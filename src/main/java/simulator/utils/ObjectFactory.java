...
public class ObjectFactory {
    ...
    public static DynamicActivity newDynamicActivity(String name, Iteration breakdownElement) {
    ...
    public static DynamicProcess newDynamicProcess(Process process) {
	DynamicProcess dynamicProcess = new DynamicProcess();
	dynamicProcess.setVariabilityType(VariabilityType.NA);
	dynamicProcess.setName(process.getName());
	dynamicProcess.setPresentationName(process.getPresentationName());
