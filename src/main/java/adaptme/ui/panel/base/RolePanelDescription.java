...
public abstract class RolePanelDescription extends JPanel {
    ...
    public RolePanelDescription(Element element, TabbedPanel tabbedPanel, MethodLibraryHash hash, AdaptMeUI owner) {
	...
	JLabel lblProvideVersionInformation = new JLabel("Provide version information about this element.");
	...
	groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
		...
		.addGroup(groupLayout.createSequentialGroup().addGap(10)
			.addComponent(lblName, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE).addGap(93)
			.addComponent(textFieldName, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE).addGap(19))
		...
		.addGroup(
			groupLayout.createSequentialGroup().addGap(6)
				...
				.addGap(30).addComponent(scrollPane_2, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)
				.addGap(19))
		.addGroup(
			groupLayout.createSequentialGroup().addGap(6)
				.addComponent(lblkeyConsiderations, GroupLayout.PREFERRED_SIZE, 81,
					GroupLayout.PREFERRED_SIZE)
				.addGap(56).addComponent(scrollPane_3, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)
				.addGap(19))
		.addGroup(groupLayout.createSequentialGroup().addGap(6).addComponent(lblStaffingInformation,
		...
		.addGroup(groupLayout.createSequentialGroup().addGap(6)
			.addComponent(lblVersion, GroupLayout.PREFERRED_SIZE, 51, GroupLayout.PREFERRED_SIZE).addGap(86)
			.addComponent(textFieldVersion, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE).addGap(19))
		.addGroup(groupLayout.createSequentialGroup().addGap(6)
			.addComponent(lblAuthors, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE).addGap(83)
			.addComponent(scrollPane_8, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE).addGap(
				20))
		.addGroup(groupLayout.createSequentialGroup().addGap(6)
			.addComponent(lblCopyright, GroupLayout.PREFERRED_SIZE, 63, GroupLayout.PREFERRED_SIZE)
			.addGap(73).addComponent(scrollPane_9, GroupLayout.DEFAULT_SIZE, 227, Short.MAX_VALUE).addGap(8)
			.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(btnSelectCopyright, GroupLayout.PREFERRED_SIZE, 100, Short.MAX_VALUE)
				.addGroup(groupLayout.createSequentialGroup().addGap(1).addComponent(
					btnDeselectCopyright, GroupLayout.PREFERRED_SIZE, 100, Short.MAX_VALUE)))
			.addGap(19))
		.addGroup(groupLayout.createSequentialGroup().addGap(6).addComponent(lblContentVariability,
			GroupLayout.PREFERRED_SIZE, 117, GroupLayout.PREFERRED_SIZE))
		.addGroup(groupLayout.createSequentialGroup().addGap(6).addComponent(lblSpecifyHowThis,
			GroupLayout.PREFERRED_SIZE, 279, GroupLayout.PREFERRED_SIZE))
		.addGroup(
			groupLayout.createSequentialGroup().addGap(6)
				.addComponent(lblVariabilityType, GroupLayout.PREFERRED_SIZE, 95,
					GroupLayout.PREFERRED_SIZE)
				.addGap(40).addComponent(comboBoxVariabilityType, 0, 335, Short.MAX_VALUE).addGap(
					21))
		.addGroup(groupLayout.createSequentialGroup().addGap(6)
			.addComponent(lblBase, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE).addGap(102)
			.addComponent(scrollPane_10, GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE).addGap(10)
			.addComponent(btnSelectBase, GroupLayout.PREFERRED_SIZE, 99, Short.MAX_VALUE).addGap(19))
		.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup().addGap(6)
			...
			.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
				.addComponent(lblPresentationName, GroupLayout.PREFERRED_SIZE, 131,
					GroupLayout.PREFERRED_SIZE)
				.addGap(6).addComponent(textFieldPresentationName, GroupLayout.DEFAULT_SIZE, 335,
					Short.MAX_VALUE)))
			.addGap(19))
		.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup().addGap(6)
			.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(lblSynonyms, GroupLayout.PREFERRED_SIZE, 66,
						GroupLayout.PREFERRED_SIZE)
					.addGap(65)
					.addComponent(scrollPane_6, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE))
			.addGroup(groupLayout.createSequentialGroup()
				.addComponent(lblSkills, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
				.addGap(96).addComponent(scrollPane_4, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE))
			.addGroup(Alignment.LEADING,
				groupLayout.createSequentialGroup()
					.addComponent(lblassignmentApproaches, GroupLayout.PREFERRED_SIZE, 61,
						GroupLayout.PREFERRED_SIZE)
					.addGap(70)
					.addComponent(scrollPane_5, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)))
			.addGap(25))
		.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup().addGap(6)
			.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(lblChangeDescription, GroupLayout.PREFERRED_SIZE, 126,
						GroupLayout.PREFERRED_SIZE)
					.addGap(10)
					.addComponent(scrollPane_7, GroupLayout.DEFAULT_SIZE, 336, Short.MAX_VALUE))
			.addGroup(
				groupLayout.createSequentialGroup()
	...
	groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
		...
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			.addGroup(groupLayout.createSequentialGroup()
				.addComponent(lblBriefDescription, GroupLayout.PREFERRED_SIZE, 15,
					GroupLayout.PREFERRED_SIZE)
				.addGap(61).addComponent(lblDetailInformation, GroupLayout.PREFERRED_SIZE, 17,
					GroupLayout.PREFERRED_SIZE))
			.addComponent(scrollPane_1, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE))
		.addGap(18)
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			.addComponent(lblMainDescription, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)
			.addComponent(scrollPane_2, GroupLayout.PREFERRED_SIZE, 116, GroupLayout.PREFERRED_SIZE))
		.addGap(6)
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			.addGroup(groupLayout.createSequentialGroup().addGap(12).addComponent(lblkeyConsiderations,
		...
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			...
			.addGroup(groupLayout.createSequentialGroup().addGap(65).addComponent(scrollPane_4,
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(lblSynonyms, GroupLayout.PREFERRED_SIZE, 15,
						GroupLayout.PREFERRED_SIZE)
					.addGap(50).addComponent(lblVersionInformation, GroupLayout.PREFERRED_SIZE, 17,
						GroupLayout.PREFERRED_SIZE))
		...
		.addGap(6)
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			.addGroup(groupLayout.createSequentialGroup().addGap(2).addComponent(lblChangeDate,
				GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
			.addComponent(textFieldDate, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE))
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			.addGroup(groupLayout.createSequentialGroup().addGap(18).addComponent(lblChangeDescription,
				GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
			.addGroup(groupLayout.createSequentialGroup().addGap(3).addComponent(scrollPane_7,
		...
		.addPreferredGap(ComponentPlacement.RELATED)
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			.addGroup(groupLayout.createSequentialGroup().addGap(6).addComponent(lblCopyright,
				GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
			.addGroup(groupLayout.createSequentialGroup().addGap(4).addComponent(scrollPane_9,
				GroupLayout.PREFERRED_SIZE, 66, GroupLayout.PREFERRED_SIZE))
			.addGroup(groupLayout.createSequentialGroup()
				.addComponent(btnSelectCopyright, GroupLayout.PREFERRED_SIZE, 27,
					GroupLayout.PREFERRED_SIZE)
				.addGap(12).addComponent(btnDeselectCopyright, GroupLayout.PREFERRED_SIZE, 27,
					GroupLayout.PREFERRED_SIZE)))
		.addGap(12)
		...
		.addGap(6)
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			.addGroup(groupLayout.createSequentialGroup().addGap(3).addComponent(lblVariabilityType,
				GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
		...
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
			...
			.addGroup(groupLayout.createSequentialGroup().addGap(9).addComponent(btnSelectBase,
