...
public abstract class PanelWorkProducts extends JPanel {
    ...
    public PanelWorkProducts(Element element, TabbedPanel tabbedPanel, MethodLibraryHash hash, AdaptMeUI owner) {
	...
	JLabel lblSpecifyWorkProducts = new JLabel("Specify work products that this role is responsible for.");
	...
	JLabel lblWorkProductsThat = new JLabel("Work products that are output of tasks that this role performs:");
	...
	groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
		...
		.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(lblWorkProducts)
			...
			.addGroup(groupLayout.createSequentialGroup()
				.addComponent(scrollPane_0, GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
					.addComponent(btnAdd, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
					.addComponent(btnRemove)))
			.addComponent(lblWorkProductsThat)
			.addGroup(groupLayout.createSequentialGroup()
				.addComponent(scrollPane_1, GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE).addGap(81))
			.addGroup(groupLayout.createSequentialGroup().addComponent(lblBriefDescriptionOf)
				.addPreferredGap(ComponentPlacement.RELATED, 256, GroupLayout.PREFERRED_SIZE))
			.addGroup(groupLayout.createSequentialGroup()
				.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE).addGap(81)))
		.addGap(6)));
	groupLayout
