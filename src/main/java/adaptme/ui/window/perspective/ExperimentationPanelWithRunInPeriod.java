...
public class ExperimentationPanelWithRunInPeriod extends JPanel {
	...
	public ExperimentationPanelWithRunInPeriod(WorkProductResourcesPanel workProductResourcesPanel, JTabbedPane tabbedPaneActivity4, SimulationFacade simulationFacade) {
