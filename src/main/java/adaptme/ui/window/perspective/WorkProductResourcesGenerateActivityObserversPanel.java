...
public class WorkProductResourcesGenerateActivityObserversPanel extends JPanel {
	...
	public WorkProductResourcesGenerateActivityObserversPanel(int i, String workProductName, String borderTitle) {
